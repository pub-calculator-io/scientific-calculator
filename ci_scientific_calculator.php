...
Version: 1.0.0
Author: Scientific Calculator / www.calculator.io
...
function display_calcio_ci_scientific_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_scientific_calculator', 'display_calcio_ci_scientific_calculator' );